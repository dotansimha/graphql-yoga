...
As an optional exercise for internaling the knowledge, you can now also implement validation of the `body` argument. You wouldn't want anyone to post an empty body, right?
