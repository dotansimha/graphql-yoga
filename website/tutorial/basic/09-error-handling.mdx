...
This is great, but now we never know whether our request failed because of authentication issues or some other unexpected issue 9e.g. a corrupted database 🤔).
