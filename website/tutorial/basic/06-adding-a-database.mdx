---
id: 06-adding-a-database
title: Adding a Database
sidebar_label: Adding a Database
---

Your GraphQL API can connect to any kind of data source, such as a remote REST (or even GraphQL) API or database. In this chapter we are covering connecting to an relational SQL database.
...
```bash
npm install --save-dev --save-exact prisma @prisma/client
```
