...
One of the goals of graphql-yoga was to have as few `graphql-yoga` packages as possible.
...
Furthermore, Yoga has a full end2end testing suite that actually deploys to all those runtimes in order to ensure integrity and prevent unexpected issues.

### Powerful Plugin System

Envelopis a powerful GraphQL plugin system, that is unfortunately not fully compatible with Apollo Server.
...
GraphQL Yogas APIs are designed for code-splitting as supported by popular bundlers.
