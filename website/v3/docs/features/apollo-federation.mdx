...
You'll need the `@graphql-yoga/apollo-inline-trace` Yoga plugin for this.

### Installation

<PackageInstall
  packages={['graphql-yoga', '@graphql-yoga/apollo-inline-trace', 'graphql']}
/>
...
import { createYoga } from 'graphql-yoga'
import { createServer } from 'http'
import { useApolloInlineTrace } from '@graphql-yoga/apollo-inline-trace'
