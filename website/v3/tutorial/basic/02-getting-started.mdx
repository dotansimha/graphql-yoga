...
The `DocumentNode` is a abstract syntax tree (AST), an intermediate format that represents the operation string in a more processable friendly way for machines.
