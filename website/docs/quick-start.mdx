...
<PackageInstall packages={['graphql', '@graphql-yoga/node@alpha']} />
...
Use your favorite schema building library such as [GiraphQL](https://giraphql.com/), [gqtx](https://github.com/sikanhe/gqtx), [GraphQL Nexus](https://nexusjs.org/) or plain [graphql-js schema classes](https://graphql.org/graphql-js/type/#graphqlschema).
