...
GraphQL Yoga v2 does no longer include `graphql-middleware` by default as using it can result in bad performance as it wraps all field resolvers within the schema.
