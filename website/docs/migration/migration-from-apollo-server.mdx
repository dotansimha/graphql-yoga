...
Some features that are included within apollo-server by default must be installed as envelop plugins ([Lern more about envelop plugins here](/docs/features/envelop-plugins)).
