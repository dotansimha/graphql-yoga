...
In addition GraphQL Yoga also support GraphQL Subscriptions over WS (via `graphql-ws`) and in addition to that.

Instead of GraphQL Subscriptions, Yoga users can also use GraphQL Live Queries.
...
- [Bundlephobia `graphql-yoga`](https://bundlephobia.com/package/graphql-yoga@three)
- [Bundlephobia `apollo-server-micro`](https://bundlephobia.com/package/@apollo/server)
...
- [Dependency visualizer `@apollo/server`](https://npm.anvaka.com/#/view/2d/apollo-server-micro)
