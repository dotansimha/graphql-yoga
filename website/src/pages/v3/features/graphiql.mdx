...
<Callout>
  Be aware that this does not really make your GraphQL server more secure. As
...
So if your goal is to avoid unknown actors from reverse-engineering your GraphQL schema and executing arbitrary operations, it is highly recommended to use persisted operations.
