...
Yoga is aware of the usefulness of a health check and gives the user maximum posibilities to use the built-in check and create a "readiness" check through a simple plugin.
