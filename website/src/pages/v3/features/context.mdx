...
- `res` - [Fetch API `Response` object](https://developer.mozilla.org/en-US/docs/Web/API/Response) that represents the outgoing HTTP response in platform-independent way.
