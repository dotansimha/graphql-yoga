...
middleware as we show in our [express](/docs/integrations/integration-with-express) and
[Next.js](/docs/integrations/integration-with-nextjs) recipes.
...
[koa](/docs/integrations/integration-with-koa), because of their custom request handling behavior.
It is not possible to use a basic Node.js
...
[the integration guide](/docs/integrations/integration-with-cloudflare-workers), the WHATWG
