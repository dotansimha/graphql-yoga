# Configuring CORS with Yoga

CORS stands for Cross-Origin Resource Sharing. In a nutshell, as a security measure, browsers aren't allowed to access resources outside their domain.
...
1. Avoid CORS by proxying your requests\_
...
2. Configure Yoga to send back CORS headers\_
