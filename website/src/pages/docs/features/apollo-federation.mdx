---
description: Learn how to use GraphQL Yoga with Apollo Federation to build a gateway server and a federated service.
---
...
Check our [working example](https://github.com/dotansimha/graphql-yoga/tree/main/examples/apollo-federation) to try it out.
