...
<Callout>
  ...
  can use [Schema Stitching](https://graphql-tools.com/docs/schema-stitching/stitch-federation).
</Callout>
...
<PackageCmd
  packages={['@graphql-yoga/node @apollo/gateway @envelop/apollo-federation graphql@15']}
/>
