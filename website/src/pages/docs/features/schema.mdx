...
Whether you're using a library such as [Pothos](https://pothos-graphql.dev), [GraphQL Nexus](https://nexusjs.org), [gqtx](https://github.com/sikanhe/gqtx), or vanilla [`graphql-js`](https://graphql.org/graphql-js/type/#graphqlschema),
as long as it provides you with a `GraphQLSchema` to `schema`, you can pass it to GraphQL Yoga.
...
<Callout type="warning">
  We do not recommend building a GraphQL schema from scratch for every single
  incoming request. Please, use a caching mechanism or pre-build your GraphQL
  schemas before starting the server.
</Callout>
