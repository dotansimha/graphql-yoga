...
<Callout>
  Automatic Persisted Queries do not provide any security features, the benefit of using them is to
  reduce network overhead. If you want to avoid executing arbitrary GraphQL operations please use
  [Persisted Operations](/v3/features/persisted-operations).
</Callout>
...
unique entries ([`tiny-lru`](https://github.com/avoidwork/tiny-lru)).
