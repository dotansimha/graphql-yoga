...
curl -X GET -H 'Content-Type: application/json' "http://localhost:4000/graphql?query={me{id name}}" -v
...
curl -H "Accept: application/json" -H "If-None-Match: 2c0ebfe7b2b0273029f2fa23a99d213b56f4838756b3ef7b323c04de1e836be3" -H "If-Modified-Since: Wed Feb 15 2023 15:23:55 GMT" "http://localhost:4000/graphql?query=\{me\{id,name\}\}"
```
