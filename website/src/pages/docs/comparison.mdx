...
- and
  [more](https://the-guild.dev/graphql/yoga-server/docs/integrations/z-other-environments)
...
GraphQL Yoga supports [file uploads out of the box](/docs/features/file-uploads#enable-file-uploads-in-graphql-yoga) and fully supports the [GraphQL-Multipart-Request](https://github.com/jaydenseric/graphql-multipart-request-spec).

### Real time and GraphQL Subscriptions

GraphQL Yoga, compared to Apollo Server, has built-in support for [simple subscriptions over Server-Sent Events (SSE)](/docs/features/subscriptions#subscriptions) without the need of any additional libraries.
...
The migration from Apollo Server to Yoga Server is easy, and you can find [instructions here](https://the-guild.dev/graphql/yoga-server/docs/migration/migration-from-apollo-server).
