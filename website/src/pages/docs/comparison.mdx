...
You only need to search for [`apollo-server-` on NPM](https://www.npmjs.com/search?q=apollo-server-)
to see how many variants and packages there are for apollo and how hard it is to maintain.
...
GraphQL Yoga will continuously support all platforms and runtimes **wihtout any changes in your
...
Node
([Express](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-express),
[Fastify](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-fastify),
[Koa](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-koa),
[NestJS](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-nestjs),
[SvelteKit](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-sveltekit)),
...
[NextJS API Routes](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-nextjs),
[Bun](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-bun) and
[more](https://www.the-guild.dev/graphql/yoga-server/v3/integrations/z-other-environments)..

### Powerful Plugin System

GraphQL Yoga is built on top of [Envelop](https://envelop.dev/) - the powerful GraphQL
[plugin system](https://www.envelop.dev/plugins).
...
Futhrermore, Yoga a default plugin preset enabled for ensuring best practices for a performant
...
[the envelop plugin hub](https://www.envelop.dev/plugins).
...
[file uploads out of the box](/v3/features/file-uploads#enable-file-uploads-in-graphql-yoga) and
fully supports the
...
[simple subscriptions over Server-Sent Events (SSE)](/v3/features/subscriptions#subscriptions)
...
GraphQL Yogas APIs are designed for code-splitting and thus have no side effects, where Apollo
...
[popular benchmarks](https://github.com/graphql-crystal/benchmarks).
...
[instructions here](https://www.the-guild.dev/graphql/yoga-server/v3/migration/migration-from-apollo-server).
