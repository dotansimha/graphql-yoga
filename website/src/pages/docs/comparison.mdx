---
description: This comparison highlights the main differences when using Yoga instead of Apollo Server.
---
...
You only need to search for [`apollo-server-` on NPM](https://npmjs.com/search?q=apollo-server-) to see how many variants and packages there are for apollo and how hard it is to maintain.

<Callout type="warning">
  **Note**: Since Apollo Server v4, Apollo does no longer maintain the
  `apollo-server-` packages and instead relies on community contributors to step
  up and take over ownership and maintenance of HTTP frameworks specific adapter
  packages.
</Callout>
...
- Node.js
  ([Express](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-express),
  [Fastify](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-fastify),
  [Koa](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-koa),
  [NestJS](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-nestjs),
  [SvelteKit](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-sveltekit))
- [AWS Lambda](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-aws-lambda)
- [Cloudflare Workers](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-cloudflare-workers)
- [Deno](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-deno)
- [NextJS API Routes](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-nextjs)
- [Bun](https://the-guild.dev/graphql/yoga-server/v3/integrations/integration-with-bun)
- and
  [more](https://the-guild.dev/graphql/yoga-server/v3/integrations/z-other-environments)

### Powerful Plugin System

GraphQL Yoga is built on top of [Envelop](https://envelop.dev) - the powerful GraphQL [plugin system](https://envelop.dev/plugins).
...
Furthermore, Yoga a default plugin preset enabled for ensuring best practices for a performant (parse and validation caching) and secure GraphQL (e.g. though error masking) server by default.
If you want to opt-out of some or all of these plugins that is also possible.

Yoga is fully customizable for your needs!

You can find a list of all available Envelop plugins over on [the envelop plugin hub](https://envelop.dev/plugins).
...
GraphQL Yoga ships with the latest and open source [GraphiQL 2 IDE](https://github.com/graphql/graphiql).
...
The migration from Apollo Server to Yoga Server is easy, and you can find [instructions here](https://the-guild.dev/graphql/yoga-server/v3/migration/migration-from-apollo-server).
