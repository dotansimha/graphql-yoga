---
description: Migrate from Express GraphQL to GraphQL Yoga. GraphQL Yoga is a fully-featured GraphQL Server with focus on easy setup, performance & great developer experience.
---
