...
<Callout>
  ...
  [here](https://github.com/dotansimha/graphql-yoga/tree/master/examples/nextjs).
</Callout>
...
<Callout>
  You can also check a full example on our GitHub repository
  [here](https://github.com/dotansimha/graphql-yoga/tree/master/examples/nextjs-auth).
</Callout>
