---
description: Implement signup and login functionality that allows your users to authenticate against your GraphQL server.
---
...
<PackageCmd
  packages={['-D --save-exact @types/jsonwebtoken @types/bcryptjs']}
/>
