import { Instruction, Callout } from '@theguild/components'
...
Furthermore, you should limit the `take` argument to be within a range that makes sense for the feed. The original hacker news shows 30 links per page.
