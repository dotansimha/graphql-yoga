...
![another `Query` root type field called feed](../../../../public/assets/tutorial/basic/05-a-simple-mutation/feed-link-query-response.png)
...
![data returned from the server](../../../../public/assets/tutorial/basic/04-a-simple-query/feed-query-response.png)
