...
Let's now quickly talk about how a GraphQL server resolves incoming requests. As you already saw, a GraphQL operation contains selection set of _fields_ that have their source in the type definitions of the GraphQL schema.
...
the element inside the `links` list.
