...
description: Implement the first GraphQL object types and fields that provide the functionality of a Hacker News
---
...
to one resolver execution level. Therefore, the above query operation has two of these execution levels.
...
<Callout>
  ...
  the server will work in the same way as it did before 👌. We just wanted you
