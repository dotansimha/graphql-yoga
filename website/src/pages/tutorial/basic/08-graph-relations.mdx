...
Another popular feature of Hackernews is to comment on links for attacking and criticizing the original poster. We don't want to miss out on that comment feature!
...
This command has now generated your second migration inside of `prisma/migrations`, and you can start to see how this becomes a historical record of how your database evolves. This script also runs the Prisma migration, so your new models and types are ready-to-use.
