import { Callout, Instruction, PackageCmd } from '@theguild/components'
...
<Callout title="info">Correct!</Callout>
It carries the _arguments_ for the field that is sent – in this case, the `url` and
...
[![Mutation response](/assets/tutorial/basic/05-a-simple-mutation/post-link-mutation-response.png)](/assets/tutorial/basic/05-a-simple-mutation/post-link-mutation-response.png)
...
[![returns the additional Link](/assets/tutorial/basic/05-a-simple-mutation/feed-link-query-response.png)](/assets/tutorial/basic/05-a-simple-mutation/feed-link-query-response.png)
