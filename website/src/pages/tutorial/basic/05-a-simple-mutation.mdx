...
![Mutation response](../../../../public/assets/tutorial/basic/05-a-simple-mutation/post-link-mutation-response.png)
...
![returns the additional Link](../../../../public/assets/tutorial/basic/05-a-simple-mutation/feed-link-query-response.png)
