---
description: Learn how to build a GraphQL HTTP server entirely from scratch using Node.js, TypeScript, GraphQL Yoga, Prisma and SQLite.
---
...
<Callout>
  ...
  repository](https://github.com/dotansimha/graphql-yoga/tree/main/examples/hackernews).
</Callout>
