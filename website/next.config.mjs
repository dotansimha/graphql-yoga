...
export default withGuildDocs({
  redirects: () =>
    Object.entries({
      ...
      '/v3/features/automatic-persisted-queries': '/docs/features/automatic-persisted-queries',
      ...
      '/v3/features/logging-and-debugging': '/docs/features/logging-and-debugging',
      '/v3/features/parsing-and-validation-caching':
        '/docs/features/parsing-and-validation-caching',
      '/v3/features/persisted-operations': '/docs/features/persisted-operations',
      ...
      '/v3/integrations/integration-with-bun': '/docs/integrations/integration-with-bun',
      '/v3/integrations/integration-with-cloudflare-workers':
        '/docs/integrations/integration-with-cloudflare-workers',
      '/v3/integrations/integration-with-deno': '/docs/integrations/integration-with-deno',
      '/v3/integrations/integration-with-express': '/docs/integrations/integration-with-express',
      '/v3/integrations/integration-with-fastify': '/docs/integrations/integration-with-fastify',
      '/v3/integrations/integration-with-koa': '/docs/integrations/integration-with-koa',
      '/v3/integrations/integration-with-nestjs': '/docs/integrations/integration-with-nestjs',
      '/v3/integrations/integration-with-nextjs': '/docs/integrations/integration-with-nextjs',
      '/v3/integrations/integration-with-sveltekit':
        '/docs/integrations/integration-with-sveltekit',
      '/v3/integrations/z-other-environments': '/docs/integrations/z-other-environments',
      '/v3/migration/migration-from-apollo-server': '/docs/migration/migration-from-apollo-server',
      '/v3/migration/migration-from-express-graphql':
        '/docs/migration/migration-from-express-graphql',
      '/v3/migration/migration-from-yoga-v1': '/docs/migration/migration-from-yoga-v1',
      '/v3/migration/migration-from-yoga-v2': '/docs/migration/migration-from-yoga-v2',
    }).map(([from, to]) => ({
      source: from,
      destination: to,
      permanent: true,
