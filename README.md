...
* [`graphql-subscriptions`](https://github.com/apollographql/graphql-subscriptions)/[`graphql-ws`](https://github.com/enisdenjo/graphql-ws)/_legacy [`subscriptions-transport-ws`](https://github.com/apollographql/subscriptions-transport-ws)_: GraphQL subscriptions server
...
| `subscriptionsServer`    | `both` or `v0` or `v1`                                           | `'both'`                                                                                      | Which websocket subscriptions server and protocol to use. `v0` for the legacy [`subscriptions-transport-ws`](https://github.com/apollographql/subscriptions-transport-ws) and `v1` for [`graphql-ws`](https://github.com/enisdenjo/graphql-ws). Defaults to `both` which implements both protocols and decides depending on the client. |
