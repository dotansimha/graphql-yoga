...
| `subscriptionsExternalEnpoint` | String or `false`                                                | false                                                                                            | Defines an alternative endpoint to be use by the [Playground](https://github.com/graphcool/graphql-playground); client for subscriptions. It is usefull when the server is hidden behind a reverse proxy that redirects requests. ()                                                                                         |
...
| `playgroundExternalEnpoint`    | String or `false`                                                | false                                                                                            | Defines an alternative endpoint to be use by the [Playground](https://github.com/graphcool/graphql-playground); client. It is usefull when the server is hidden behind a reverse proxy that redirects requests. ()                                                                                                           |
