...
* [`graphql-subscriptions`](https://github.com/apollographql/graphql-subscriptions)/[`graphql-ws`](https://github.com/enisdenjo/graphql-ws)/[`subscriptions-transport-ws`](https://github.com/apollographql/subscriptions-transport-ws): GraphQL subscriptions server
...
| `subscriptionsProtocol`    | `both` or `legacy` or `current`                                           | `'both'`                                                                                      | Which websocket subscriptions server and protocol to use. `legacy` for [`subscriptions-transport-ws`](https://github.com/apollographql/subscriptions-transport-ws) and `current` for [`graphql-ws`](https://github.com/enisdenjo/graphql-ws). Defaults to `both` implementing both protocols and deciding which one to use on the fly. |
